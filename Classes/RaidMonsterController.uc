//=============================================================================
// RaidMonsterController
// Grudge AI for the titan and its adds: never forgets the nearest player,
...
//=============================================================================
class RaidMonsterController extends MonsterController;

var Pawn GrudgeEnemy;
var bool bIsAdd;           // true = add monster, false = the titan
...
function Pawn FindNearestPlayer()
{
    local Pawn Best;
    local float bd, d;
    local Controller C;
    ...
    for (C = Level.ControllerList; C != None; C = C.NextController)
    {
        ...
        if (C.PlayerReplicationInfo == None || C.PlayerReplicationInfo.bOnlySpectator)
            continue;
        d = VSize(C.Pawn.Location - Pawn.Location);
        if (d < bd)
        {
            bd = d;
            Best = C.Pawn;
